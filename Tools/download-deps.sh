...
# We're using Xiph's GitHub mirrors because GitLab regularly times out (for me at least). I thought about timing out and
# using it as an alternative URL, but that may mess up the refs.
